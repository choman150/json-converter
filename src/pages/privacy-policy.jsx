    ...
    return (
        <>
            ...
            <p className="mb-4 text-sm text-gray-700">
                We value your privacy. This tool does not store, track, or share any data you upload or convert. All conversions are handled locally in your browser using JavaScript, and no data is
                transmitted to any server.
            </p>

            <h2 className="text-lg font-semibold mt-6 mb-2">Cookies</h2>
            <p className="mb-4 text-sm text-gray-700">This site may use cookies to improve user experience or for analytics purposes. No personally identifiable information is collected or stored.</p>
